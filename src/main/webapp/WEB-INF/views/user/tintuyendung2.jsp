                        ...
                        <div class="container__body-tilte-box" id="container__body-tilte-box">
                            ...
                            <div class="container__body-tilte-box-inforJob">
                                ...
                                <div class="container__body-tilte-box-inforJob-deadline">
                                    <i class="fa-regular fa-clock"></i> Hạn nộp hồ sơ: 21/05/2022
                                </div>
                            </div>
                        ...
                        <div class="container__body-inforCompany-infor">
                            <div class="container__body-inforCompany-infor-boxitem">
                                ...
                                <div class="container__body-inforCompany-infor-boxitem-div">
                                    ...
                                    <p class="container__body-inforCompany-infor-boxitem-text">Công ty Cổ phần Tập Đoàn SENGROUP </p>
                                    <p class="container__body-inforCompany-infor-boxitem-text">Với bề dày kinh nghiệm trong lĩnh vực Bất Động Sản cùng sự đam mê, tận tâm và nhiệt huyết của tất cả cán bộ công nhân viên, SENGROUP đã cùng với các khách hàng, đối tác gặt hái rất nhiều thành công qua các dự án và
                                    ...
                                    <p class="container__body-inforCompany-infor-boxitem-text">SỨ MỆNH</p>
                                    <p class="container__body-inforCompany-infor-boxitem-text">Mang đến cho khách hàng những sản phẩm, dịch vụ tốt nhất với sự hài lòng cao nhất.</p>
                                    <p class="container__body-inforCompany-infor-boxitem-text">Thấu hiểu, hỗ trợ và giữ uy tín để đồng hành cùng đối tác.</p>
                                    <p class="container__body-inforCompany-infor-boxitem-text">Tạo tối đa mọi điều kiện cho nhân viên phát triển đúng năng lực bản thân và hưởng xứng đáng những thành quả đạt được.</p>
                                    <p class="container__body-inforCompany-infor-boxitem-text">Chung tay góp sức vì một xã hội giàu mạnh và đầy lòng nhân ái.</p>
                                    <p class="container__body-inforCompany-infor-boxitem-text">GIÁ TRỊ CỐT LÕI</p>
                                    <p class="container__body-inforCompany-infor-boxitem-text">ĐẠO ĐỨC - TRÍ TUỆ - UY TÍN</p>
                                    <p class="container__body-inforCompany-infor-boxitem-text">Với 3 chữ làm kim chỉ nam: ĐẠO ĐỨC làm gốc, TRÍ TUỆ dẫn đường và UY TÍN để đi xa hơn, trong mọi hoạt động của công ty, chúng tôi luôn tâm niệm phải mang lại những giá trị Đích Thực cho Khách Hàng, Đối Tác và Nhân Viên.</p>
                                    <p class="container__body-inforCompany-infor-boxitem-text">Các sản phẩm Công ty đang triển khai:</p>
                                    <p class="container__body-inforCompany-infor-boxitem-text">- Đại lý phân phối các sản phẩm của Sun Group, VinGroup tại Phú Quốc.</p>
                                    <p class="container__body-inforCompany-infor-boxitem-text">- Nổi bật như các sản phẩm: Hillside Residence, The Center, The Sky, Hon Thom Paradise Island</p>
                            ...
                            <div class="container__body-inforCompany-infor-boxitem">
                                ...
                                <div class="container__body-inforCompany-infor-boxitem-div">
                                    ...
                                    <p class="container__body-inforCompany-infor-boxitem-text">100-499 nhân viên</p>
                                    <p class="container__body-inforCompany-infor-boxitem-text">
                                        <br>
                                    </p>
                                </div>
                            ...
                            <div class="container__body-inforCompany-infor-boxitem">
                                ...
                                <div class="container__body-inforCompany-infor-boxitem-div">
                                    ...
                                    <p class="container__body-inforCompany-infor-boxitem-text">Số 11-11A Đường Phạm Ngọc Thạch, Phường Võ Thị Sáu, Quận 3, Thành phố Hồ Chí Minh, Việt Nam</p>
                                    <p class="container__body-inforCompany-infor-boxitem-text">
                                        <br>
                                    </p>
                                </div>
